...
public class TeamScoring
{
    public static void main(String[] args) throws Exception {
        ...
        List<Matches> matches=Scheduler.createSchedule(teams);
        System.out.println(matches);
        Evaluator.OrganizeMatches(matches);
        Evaluator.ScoreTable(teams,matches);
    }
}
class Matches
{
...
class Scheduler
{
    public static List<Matches> createSchedule(List<Teams> teams)
    {
...
class Evaluator
{
     ...
     * @param matches
     */
    public static void OrganizeMatches(List<Matches> matches)
    {
    ...
    public static void ScoreTable(List<Teams> teams,List<Matches> matches)
    {
